...
const ModelProductSection = memo(({ product }: ModelProductSection) => {
  ...
  const { name, images, description, expiryTime } = product.product.params || {}
        ...
        <SwiperSlide>
          <div className='w-full xs:h-[800px] sm:h-[1092px]'>
            ...
            <div className='relative flex w-full items-center justify-between'>
              ...
              {/* {images?.[1] && (
                <img
                  src={hexToUtf8(images?.[1])}
                  alt='product-single'
                  className='absolute left-1/2 z-30 -translate-x-1/2 transform xs:top-[40%] xs:max-w-[90%] sm:top-[-20px] sm:h-[750px]'
                />
              )} */}

              <div className='absolute left-1/2 z-30 -translate-x-1/2 transform border border-solid xs:top-[40%] xs:max-w-[90%] sm:top-[0px] sm:h-[750px]'>
                <div className='relative size-full'>
                  {images?.[1] && <img src={images?.[1]} alt={name} className='size-full' />}
        ...
        <SwiperSlide>
          <div className='flex w-full flex-col xs:h-[790px] sm:h-[1092px] sm:justify-between'>
            ...
            <div className='relative flex w-full items-center justify-between'>
              ...
              <div className='absolute left-1/2 z-30 -translate-x-1/2 transform border border-solid xs:top-[15%] xs:max-h-[310px] xs:max-w-[90%] sm:top-[-80px] sm:h-[800px]'>
                <div className='relative size-full'>
                  {images?.[2] && <img src={images?.[2]} alt={name} className='size-full' />}
                  <div className='absolute -left-3 -top-3 flex size-6 shrink-0 items-center justify-center rounded-full bg-black-main text-[14px] text-white'>
                    3
                  </div>
                </div>
              ...
              <div className='absolute left-1/2 z-[100] flex -translate-x-1/2 transform flex-col justify-center rounded-[32px] bg-white/[.44] shadow-box-content-model backdrop-blur-2xl xs:bottom-[-30%] xs:h-[224px] xs:w-[358px] xs:space-y-2 xs:p-5 sm:bottom-[8%] sm:h-[300px] sm:w-[1204px] sm:space-y-5 sm:p-10'>
                ...
                />
                <h6 className='font-customSemiBold capitalize xs:text-[16px] xs:leading-[22px] sm:text-[24px] sm:leading-8'>
                  expiry: {formatDate(+expiryTime / 1000, 'DD MMMM YYYY')}
                </h6>
              </div>
            </div>
